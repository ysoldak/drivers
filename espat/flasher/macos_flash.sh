...
bossac -i -d --port=$DEV_PATH_TTY -e -w -v --offset=0x2000 -R SerialNINAPassthrough.ino.bin
...
python $HOME/.pyenv/versions/2.7.15/lib/python2.7/site-packages/esptool.py \
    --chip esp32 \
    --port $DEV_PATH_TTY \
    --baud 921600 \
    --before no_reset \
